...
#include "tss2_mu.h"         // for Tss2_MU_UINT32_Marshal, Tss2_MU_TPMT_S...
#include "tss2_sys.h"        // for TSS2_SYS_CONTEXT, TSS2L_SYS_AUTH_COMMAND
#include "tss2_tpm2_types.h" // for TPMI_DH_OBJECT, TPMT_SIGNATURE, TPMT_TK_...
...
Tss2_Sys_VerifySequenceComplete(TSS2_SYS_CONTEXT             *sysContext,
    ...
    rval = Tss2_Sys_VerifySequenceComplete_Prepare(sysContext, sequenceHandle, keyHandle, signature);
    if (rval)
        return rval;
