...
#include "tss2_mu.h"         // for Tss2_MU_TPMT_SIGNATURE_Marshal, Tss2_MU_T...
#include "tss2_sys.h"        // for TSS2_SYS_CONTEXT, TSS2L_SYS_AUTH_COMMAND
#include "tss2_tpm2_types.h" // for TPMI_DH_OBJECT, TPMT_SIGNATURE, TPMT_TK_V...
...
Tss2_Sys_VerifySequenceComplete_Prepare(TSS2_SYS_CONTEXT     *sysContext,
    ...
    /* signature (TPMT_SIGNATURE) is not a decrypt-eligible TPM2B parameter. */
