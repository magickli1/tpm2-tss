...
TPM2B_MARSHAL_SUBTYPE(TPM2B_NV_PUBLIC_2, TPMT_NV_PUBLIC_2, nvPublic);
TPM2B_UNMARSHAL_SUBTYPE(TPM2B_NV_PUBLIC_2, TPMT_NV_PUBLIC_2, nvPublic);
TPM2B_MARSHAL_SUBTYPE(TPM2B_SET_CAPABILITY_DATA, TPMS_SET_CAPABILITY_DATA, setCapabilityData);
TPM2B_UNMARSHAL_SUBTYPE(TPM2B_SET_CAPABILITY_DATA, TPMS_SET_CAPABILITY_DATA, setCapabilityData);
