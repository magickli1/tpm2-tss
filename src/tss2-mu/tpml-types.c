...
TPML_MARSHAL(TPML_PUB_KEY, Tss2_MU_TPM2B_PUBLIC_Marshal, pubKeys, ADDR)
TPML_UNMARSHAL(TPML_PUB_KEY, Tss2_MU_TPM2B_PUBLIC_Unmarshal, pubKeys)
TPML_MARSHAL(TPML_SPDM_SESSION_INFO, Tss2_MU_TPMS_SPDM_SESSION_INFO_Marshal, spdmSessionInfo, ADDR)
TPML_UNMARSHAL(TPML_SPDM_SESSION_INFO, Tss2_MU_TPMS_SPDM_SESSION_INFO_Unmarshal, spdmSessionInfo)
